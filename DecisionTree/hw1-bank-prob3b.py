...
train_data = dt.replace_unknown(dt.numeric_to_binary(pd.read_csv("DecisionTree/Data/bank-train.csv", names = colnames, header = None), numeric_cols))

test_data = dt.replace_unknown(dt.numeric_to_binary(pd.read_csv("DecisionTree/Data/bank-test.csv", names = colnames, header = None), numeric_cols))

unk_rep_test_data = dt.replace_unknown(test_data)

unk_rep_train_data = dt.replace_unknown(train_data)
